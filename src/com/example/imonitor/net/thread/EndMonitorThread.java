...
public class EndMonitorThread extends NetThread{

	
	//private Handler mHandler;
	private String logmsg;

	public EndMonitorThread(int collectionid, int accountid, Context context) {
		super();
		message = side+"##"+END_TRANSFORM_VIDEO+"##"+collectionid+"$"+accountid;
	}
